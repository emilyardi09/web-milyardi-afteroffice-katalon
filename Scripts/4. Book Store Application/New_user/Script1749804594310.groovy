...
WebUI.click(findTestObject('Book Store Application/new_user_btn'))

WebUI.scrollToPosition(0, 400)

WebUI.delay(2)

WebUI.setText(findTestObject('Book Store Application/first_name_txt'), 'eiffel')

WebUI.setText(findTestObject('Book Store Application/last_name_txt'), 'cake')
